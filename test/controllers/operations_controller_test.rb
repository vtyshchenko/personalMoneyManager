...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference("Operation.count") do
      post operations_url, params: { operation: { amount: @operation.amount, description: @operation.description, odate: @operation.odate } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { amount: @operation.amount, description: @operation.description, odate: @operation.odate } }
